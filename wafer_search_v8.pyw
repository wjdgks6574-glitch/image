...
v8 변경사항: 4번째 날짜 형식 추가. 앞 4자리를 제외한 다음 6자리가 시(HH) 없이
YYMMDD 그대로(전부 숫자, 2자리씩)인 형식 지원 (예: AVL3260708B85079 ->
260708 -> 2026-07-08). SQL DB 조회 결과(CT_SORTERRESULT) 58,497건 실측
데이터로 검증: 정확히 일치 58,242건, +-1일 이내 255건, 못 찾은 건 0건.
"""
