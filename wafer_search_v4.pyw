...
v4 변경사항: waferID에서 날짜를 못 찾을 경우(예: A1L6265208320270 처럼
"숫자6자리+A" 패턴이 없는 형식)의 전체 검색(fallback)도 날짜 폴더 단위로
병렬 처리하도록 개선. 기존에는 os.walk 하나로 전체를 순차 탐색해 매우
느렸음.
"""
